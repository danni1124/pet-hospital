            ...
            <div class="notification-dropdown" v-if="showNotificationDropdown">
              ...
              <div class="notification-list">
                ...
                >
                  ...
                  <div class="pet-info">
                      <div class="pet-name">{{application.pet.petName }}</div>
                      <div class="pet-status">
                          <!-- 宠物类型标签 -->
                          <span  class="type-tag1" :class="getTypeClass(application.pet.type)">
      ...
      <div v-else class="pet-container">
          ...
          >
              ...
              <div class="pet-header">
                  <div class="pet-image" :class="{ editing: pet.editing }" @click="onImageClick(pet)">
                  ...
                  <div class="batch-list-container">
                      ...
                      <div class="table-container">
                          <table class="batch-table">
                              <thead>
                                  <tr>
                                      <th style="width: 58px;text-align:left;">宠物姓名</th>
                                      <th style="width: 30px;text-align:left;">类型</th>
                                      <th style="width: 30px;text-align:left;">性别</th>
                                      <th style="width: 30px;text-align:left;">年龄</th>
                                      <th style="width: 58px;text-align:left;">重量</th>
                                      <th style="width: 45px;text-align:left;">状态</th>
                                      <th style="width: 90px;text-align:left;">病症</th>
                                      <th style="width: 150px;text-align:left;">主人/描述</th>
          ...
          <div class="modal-container">
              ...
              <div class="modal-body">
                  <div class="pdf-controls">
                      <button class="btn btn-primary" @click="zoomPdf(0.8)">
                          <i class="fas fa-search-minus"></i> 缩小
                      </button>
                      <button class="btn btn-primary" @click="zoomPdf(1.2)">
...
.pet-image.editing:hover::after {
    opacity: 1;
}

.pet-image input[type="file"] {
    position: absolute;
    width: 100%;
    height: 100%;
    top: 0;
